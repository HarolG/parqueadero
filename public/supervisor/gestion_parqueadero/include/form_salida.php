<?php
    ...
    if(isset($_POST['nom_estado_cupo'])) {
        ...
        $sql = "UPDATE detalle_cupos SET id_deta_vehiculo = NULL, id_estado = '1' WHERE detalle_cupos.id_deta_cupos = '$salida_deta_cupos'";
        $query = mysqli_query($mysqli, $sql);
         
        $sql2 = "SELECT * FROM registro_parqueadero, detalle_vehiculo WHERE detalle_vehiculo.id_deta_vehiculo = registro_parqueadero.id_deta_vehiculo AND placa = '$placa' AND documento = '$documento' AND id_estado = 6";
